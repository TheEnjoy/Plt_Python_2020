...
| 9 | 01.12.2020 | Веб-скрапинг: использование API (на примере ВКонтакте)| - Конспект (TBD) <br> - [Задания](https://github.com/LanaLob/Plt_Python_2020/blob/master/Seminar%20tasks/seminar9.ipynb) <br>  - Решения (TBD) <br> - Запись семинара (TBD) | Нет | Нет |
