...
| 8 | 24.11.2020 | Веб-скрапинг: автоматизация работы браузера с помощью Selenum WebDriver | - Конспект (TBD) <br> - Задания (TBD) <br>  - Решения (TBD) <br> - Запись семинара (TBD) | Домашнее задание 7 (TBD) <br> *дедлайн: 02.12.20* | Нет |
